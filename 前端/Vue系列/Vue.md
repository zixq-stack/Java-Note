...
- {{xxx}}中的xxx要写js表达式（ {{}} 即为插值表达式 ），且xxx可以自动读取到**data中的所有属性**
  - js表达式 和 js代码的区分
...
- 2、双向绑定 （ v-model ） ，数据不仅能从data流向页面，还可以从页面流向data，但需注意如下两点
  ...
  - 2、v-model：value 可以简写为 v-model，因为：v-model默认收集的就是值
...
![1641971830669](C:\Users\ZiXieQing\AppData\Roaming\Typora\typora-user-images\1641971830669.png)
...
![1641972531120](C:\Users\ZiXieQing\AppData\Roaming\Typora\typora-user-images\1641972531120.png)
...
**效果如下**
![image](https://img2020.cnblogs.com/blog/2421736/202201/2421736-20220113120257088-1936139251.png)

——————————————————————————————————————————————————

![image](https://img2020.cnblogs.com/blog/2421736/202201/2421736-20220113120312641-209453961.png)
...
![image](https://img2020.cnblogs.com/blog/2421736/202201/2421736-20220113122345738-1258613278.png)
...
- 上面这样做之后，看起来好像成功了，但是运行一会就会发现：电脑的风扇会使劲儿转，而且要是在change()中输出一句话的话，会发现：执行了N多次，一直在跑^_^
- 原因：
...
![image](https://img2022.cnblogs.com/blog/2421736/202201/2421736-20220119144323863-1390794462.png)
